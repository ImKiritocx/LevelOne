...
public class DrumKit extends MouseAdapter {
    ...
    p.setLayout(new GridLayout());
   	 ...
   	 String drum2 = "anothercartoondrum.png";
   	 anotherDrum=createLabelImage(drum2);
   	 anotherDrum.addMouseListener(this);
   	 p.add(anotherDrum);
   	z.pack();
    }
    ...
    public void mouseClicked(MouseEvent e) {
   	 ...
   	 else if (drumClicked==anotherDrum) {
		playSound("anotherdrumsound.wav");
	}
