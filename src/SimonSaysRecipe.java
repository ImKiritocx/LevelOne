...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
  	images.put(new Integer(KeyEvent.VK_UP), "Arrowdown.png");
  	images.put(new Integer(KeyEvent.VK_UP), "Arrowup.png");
  	images.put(new Integer(KeyEvent.VK_UP), "Arrowleft.png");
  	images.put(new Integer(KeyEvent.VK_UP), "Arrowright.png");
