...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panelm = createHeader("Movies");
		// 4. Add the header component to the quizPanel
		quizPanel.add(panelm);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("What popular movie involves a dinosaur park", "jurassic park", 200);
		}
		if (buttonPressed == secondButton) {
			askQuestion("what is the blue and white robot's name from Star Wars", "r2d2", 400);
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Otherwise
			...
			score -= prizeMoney;
			JOptionPane.showMessageDialog(null, "the correct answer is jurassic park");
			updateScore();
		}
		...
		if (answer2.equalsIgnoreCase(correctAnswer)) {
			...
			score -= prizeMoney;
			JOptionPane.showMessageDialog(null, "the correct answer is r2d2");
			updateScore();
		}
